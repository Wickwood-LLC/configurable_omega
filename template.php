...
function configurable_omega_preprocess_html(&$vars) {
  $viewport = array(
   '#tag' => 'meta',
   '#attributes' => array(
     'name' => 'viewport',
...
function configurable_omega_field_multiple_value_form($variables) {
 ...
 */
function configurable_omega_preprocess_page(&$vars) {
  // You can use preprocess hooks to modify the variables before they are passed
  // to the theme function or template file.

  _configurable_omega_local_tasks($vars);
}

/**
 * Override of theme('menu_local_task').
 */
function configurable_omega_menu_local_task($variables) {
...
function _configurable_omega_local_tasks(&$vars) {
  // dpm($vars);
...
function configurable_omega_menu_local_tasks(&$variables) {
  $output = '';
...
function configurable_omega_breadcrumb($variables) {
